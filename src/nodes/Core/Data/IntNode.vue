...
function validateInt() {
  const parsed = parseInt(props.data.value)
  if (isNaN(parsed)) {
    props.data.value = '0'
...
.custom-node.int-node .node-body {
  padding-left: 10px;
  padding-right: 10px;
}
