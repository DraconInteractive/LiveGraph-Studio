...
props.data.class = 'find-sentient-name-node'
...
<template>
    ...
    >
        <template #body>         
            ...
            <div class="find-sentient-name-node-body">
                <input
                v-model="stringValue"
                type="text"
                placeholder="Enter string..."
                class="find-sentient-name-node-string-input"
                />
            </div>
        </template>
...
.custom-node.find-sentient-name-node .node-body {
  padding-left: 10px;
  padding-right: 10px;
}

.find-sentient-name-node-body {
  display: flex;
...
.find-sentient-name-node-string-input {
  font-size: 4px;
  padding: 2px;
